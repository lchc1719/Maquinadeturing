...
$(function () {
    ...
    $('#instrucciones').click(function () {
        swal("info!", "Esta Maquina de Turing solo puede leer las letras a y b. Para agregar caracteres, simplemente escriba en el cuadro de texto (abbab) y haga clic en Ingresar, y luego haga clic en verificar expresión para ejecutar el proceso. Para detener el proceso, presione la tecla de Detener.", "info");
    });
});
